...
/**
 * BoatModelVersion - Legacy interface kept for backward compatibility.
 * (PATCH 6 - HARD CLEANUP)
 *
 * NOTE: Primary boat model management is via BoatModelService.
 * Specifications are in BoatModel.specifications.* (canonical source).
 */
