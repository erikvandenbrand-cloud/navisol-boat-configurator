...
export function ProductionProceduresTab() {
  ...
  const [taskStageCode, setTaskStageCode] = useState<ProductionStageCode | undefined>(undefined);
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Select value={toSelectValue(taskStageCode)} onValueChange={(v) => setTaskStageCode(fromSelectValue(v) as ProductionStageCode | undefined)}>
                  <SelectTrigger>
